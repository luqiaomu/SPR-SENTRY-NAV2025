...
def generate_launch_description():             
    init_x_launch_arg = DeclareLaunchArgument('init_x', default_value=TextSubstitution(text='-0.48'))
    init_y_launch_arg = DeclareLaunchArgument('init_y', default_value=TextSubstitution(text='-1.225'))
    ...
    move_strategy_config_launch_arg = DeclareLaunchArgument('move_strategy_config', 
                                                            default_value=TextSubstitution(text='/home/spr/Sentry_ws/src/SPR-RM-Sentry/src/commander/commander/config_r.yaml'))
