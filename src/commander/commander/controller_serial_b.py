...
# data 0 ff 1234yaw 5 比赛状态 6 7 剩余时间 8 9自己剩余血量 10 11剩余发弹量 12 红蓝方
#13 14 蓝方基地血量 15 16 蓝方前哨站血量 1718 红方基地 19 20 红方前哨站 21 fe
          ...
          # 发布 GameStatus
               ...
               # my == blue
                ...
                red_blue = data[12]  
                my_outpost_hp = int.from_bytes(data[15:17], byteorder='big', signed=True)
                enemy_outpost_hp = int.from_bytes(data[19:21], byteorder='big', signed=True)
                projectile_allowance_17mm = int.from_bytes(data[10:12], byteorder='big', signed=True)
                my_base_hp = int.from_bytes(data[13:15], byteorder='big', signed=True)
                enemy_base_hp = int.from_bytes(data[17:19], byteorder='big', signed=True)
